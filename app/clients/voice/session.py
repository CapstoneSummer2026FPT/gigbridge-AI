...
class VoiceSessionManager:
    ...
    async def create_session(self, data: dict) -> InterviewSession:
        ...
        mapping = {
            ...
            "question_count": str(data.get("question_count", settings.MAX_INTERVIEW_QUESTIONS)),
        ...
        return InterviewSession(
            ...
            question_count=int(mapping["question_count"]),
    ...
    async def load_or_expire(self, session_id: str) -> Optional[InterviewSession]:
        ...
        return InterviewSession(
            ...
            question_count=int(data.get("question_count", settings.MAX_INTERVIEW_QUESTIONS)),
