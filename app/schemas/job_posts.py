"""
PURPOSE: Pydantic schemas for AI-assisted job description generation, taxonomy options, and milestone hiring plans.
IMPORTANCE: Critical — Defines input/output contracts for job details writing and milestone hiring plan generation.
READING FLOW: app/schemas/job_posts.py -> app/services/job_posts/job_post_base.py -> app/services/job_posts/* -> app/api/routes/job_posts.py
"""
