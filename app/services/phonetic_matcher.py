"""Job-scoped dynamic phonetic transcript correction.

There is intentionally no always-on global phrase dictionary here. Corrections
are built at runtime from the current job's hotwords, plus optional aliases
provided with that job context.
"""
