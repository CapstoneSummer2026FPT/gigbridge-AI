...
class CandidateJudgingService:
    ...
    async def evaluate_candidate(
        ...
        system_prompt = (
            ...
            "   - Evaluate candidate's solution approach strictly against job constraints and required skills.\n"
            "   - Reward concrete implementation steps, solid architecture choices, and security/edge-case handling.\n"
            "   - Penalize buzzword soup or flawed technical logic.\n"
            "2. PILLAR 2 - VETTING SCREENING Q&A ACCURACY & REASONING (30%):\n"
            "   - Score answer correctness based on technical accuracy and domain depth.\n"
