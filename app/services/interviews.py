...
class InterviewService:
    ...
    async def analyze_vetting(self, request: AnalyzeVettingRequest) -> InterviewFeedback:
        ...
        system_prompt = (
            ...
            "5. Evaluate Candidate Answer Authenticity & AI Detection:\n"
            "   - Inspect answer syntax, tone, and structure for AI generation traits:\n"
            "     * Overt AI Cliches: Phrasing like 'Certainly!', 'Here is a comprehensive guide...', 'In conclusion/summary...'\n"
            "     * Structural Uniformity: Rigid, perfectly balanced multi-level bullet points with uniform sentence lengths.\n"
            "     * Generic Textbook Listing: Listing standard textbook steps without specific project context, personal anecdotes, or tool choices.\n"
            "   - Output `is_ai_generated` (true if AI confidence >= 0.60, false otherwise).\n"
            "   - Output `ai_confidence_score`: A float between 0.0 (Definitely Human) and 1.0 (Definitely AI Generated).\n"
            "   - Output `ai_detection_reason`: Concise explanation of AI markers or authentic human phrasing observed.\n"
            "6. Grade the Candidate's Answer (Score 0-100) using these strict guidelines:\n"
            "   - FAIRNESS RULE: Grade strictly on demonstrated technical accuracy, problem-solving depth, and practical correctness.\n"
            "     Do NOT inflate scores for AI-generated answers merely due to polished formatting, and do NOT penalize human answers for informal conversational style.\n"
            ...
            "7. Provide a concise, recruiter-focused justification Feedback for this specific answer.\n"
            "\n"
            ...
            "- Overall Authenticity & AI Detection:\n"
            "  * `is_ai_generated` (true if overall proposal is assessed as AI-generated).\n"
            "  * `ai_confidence_score` (overall AI confidence between 0.0 and 1.0).\n"
            "  * `ai_detection_summary` (summary of authenticity flags across all candidate answers).\n"
